...
$sql = "SELECT Operacion.Referencia, TipoMercancia.TipoM, Mercancia.Nombre_Merc
        FROM Operacion
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container mt-5">
        ...
        <table id="operacionesTable" class="display" style="width:100%">
            <thead>
                <tr>
                    <th>Referencia</th>
                    <th>Mercancía</th>
            ...
            <tbody>
                <?php foreach ($operaciones as $operacion): ?>
                    <tr>
                        <td><?php echo $operacion['Referencia']; ?></td>
                        <td><?php echo $operacion['Nombre_Merc']; ?></td>
                        <td><?php echo $operacion['TipoM']; ?></td>
                        <td>
                            <a href="formularioSolicitud.php?referencia=<?php echo $operacion['Referencia']; ?>" class="btn btn-primary">Crear Solicitud</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
