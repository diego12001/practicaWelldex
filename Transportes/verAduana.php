...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container mt-5">
        <h2 class="text-center">Lista de Aduanas</h2>
        <table id="aduanasTable" class="display" style="width:100%">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Estado</th>
            ...
            <tbody>
                <?php foreach ($aduanas as $aduana): ?>
                    <tr>
                        <td><?php echo $aduana['ID_Ad']; ?></td>
                        <td><?php echo $aduana['Estado_Ad']; ?></td>
                        <td><?php echo $aduana['Ubicacion_Ad']; ?></td>
                        <td><?php echo $aduana['Telefono_Ad']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
