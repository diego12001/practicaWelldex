...
<div class="container mt-5">
    <h2 class="text-center">Lista de Importadores</h2>
    <table id="importadoresTable" class="display" style="width:100%">
        <thead>
            <tr>
                <th>ID</th>
                <th>Empresa</th>
        ...
        <tbody>
            <?php foreach ($importadores as $importador): ?>
                <tr>
                    <td><?php echo $importador['ID_Imp']; ?></td>
                    <td><?php echo $importador['Empresa_Imp']; ?></td>
                    <td><?php echo $importador['Operador_Imp']; ?></td>
                    <td><?php echo $importador['Telefono_Imp']; ?></td>
                    <td><?php echo $importador['Correo_Imp']; ?></td>
                    <td><?php echo $importador['Pais_Imp']; ?></td>
                    <td><?php echo $importador['Ubicacion']; ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
