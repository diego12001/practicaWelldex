...
$sql = "SELECT Mercancia.*, TipoMercancia.TipoM 
        FROM Mercancia 
        INNER JOIN TipoMercancia ON Mercancia.ID_TipoM = TipoMercancia.ID_TipoM";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container mt-5">
        <h2 class="text-center">Lista de Mercancías</h2>
        <table id="mercanciasTable" class="display" style="width:100%">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Nombre</th>
            ...
            <tbody>
                <?php foreach ($mercancias as $mercancia): ?>
                    <tr>
                        <td><?php echo $mercancia['ID_Merc']; ?></td>
                        <td><?php echo $mercancia['Nombre_Merc']; ?></td>
                        <td><?php echo $mercancia['Marca_Merc']; ?></td>
                        <td><?php echo $mercancia['Peso_Merc']; ?></td>
                        <td><?php echo $mercancia['Volumen_Merc']; ?></td>
                        <td><?php echo $mercancia['Dimensiones_Merc']; ?></td>
                        <td><?php echo $mercancia['TipoM']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
